const formulas = {
  ...
  matematica: {
    ...
    'lei-dos-cosseos': { vars: ['lado1 (m)', 'lado2 (m)', 'angulo (°)'], text: 'Informe dois lados e o ângulo entre eles.' },
...
function updateInstructions(category, formula) {
